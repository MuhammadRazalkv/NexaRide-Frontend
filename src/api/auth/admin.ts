...
export async function updateStatus(id: string) {
    try {
        const response = await axiosAdminInstance.patch('/user/changeStatus', { id })
        console.log(response.data);
...
export async function getDrivers() {
    try {
        const response = await axiosAdminInstance.get('/getDrivers')
        console.log(response.data);
...
export async function toggleBlockUnblockDriver(id: string) {
    try {
        const response = await axiosAdminInstance.patch('/driver/toggleBlockUnblock', { id })
        console.log(response.data);
...
export async function rejectDriver(driverId: string, reason: string) {
    try {
        ...
        if (axios.isAxiosError(err) && err.response) {
            console.log("Error message from reject vehicle :", err.response.data.message);
            throw new Error(err.response.data.message);
        } else if (err instanceof Error) {
            console.log(err.message);
            throw new Error(err.message);
...
export async function getVehicleById(vehicleId: string) {
    try {
        ...
        const response = await axiosAdminInstance.get(`/getVehicleInfo/${vehicleId}`)
        console.log(response.data);
...
export async function approveVehicleById(vehicleId: string,category:string) {
    try {
        ...
        if (axios.isAxiosError(err) && err.response) {
            console.log("Error message from approve vehicle:", err.response.data.message);
            throw new Error(err.response.data.message);
        } else if (err instanceof Error) {
            console.log(err.message);
            throw new Error(err.message);
...
export async function updateFare(fare:Fare) {
    try {
        ...
        if (axios.isAxiosError(err) && err.response) {
            console.log("Error message from update fare :", err.response.data.message);
            throw new Error(err.response.data.message);
        } else if (err instanceof Error) {
            console.log(err.message);
            throw new Error(err.message);
